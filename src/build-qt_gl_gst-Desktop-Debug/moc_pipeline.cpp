...
QT_MOC_LITERAL(5, 39, 4)
    ...
    "Pipeline\0newFrameReady\0\0vidIx\0finished\0"
    "Stop\0"
};
...
void Pipeline::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->newFrameReady((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (Pipeline::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Pipeline::finished)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void Pipeline::newFrameReady(int _t1)
{
...
// SIGNAL 1
void Pipeline::finished(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
